...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/matlab-%23DD0031.svg?style=for-the-badge&logo=matlab&logoColor=white" alt="MATLAB">
...
|-----------------------------------------------------------------------------------|--------------------------------------|---------------------------------------|----------------------------------------|-----------------------------------------|-----------------------------------------|
| Mobilní aplikace pro organizátory dětských aktivit 				    | ![Java][java] | ![android-studio][android-studio] |                                        | ![sqlite][sqlite] |                                         |
| Webová aplikace banky s přihlášením, 2FA ověřením a šifrováním dat 		    | ![Java][java] | ![spring][spring] |                                        |                                         |                                         |
| Bakalářský projekt - Integrace ESP32 do systému pro chytrou domácnost 	    | ![c++][c++] ![c][c] |                                       |                                        |                                         |                                         |
| Klikací webová hra s databází a přihlášením (3-vrstvá architektura) 		    | ![Java][java] ![ts][ts] |                                       |                                        |                                         |                                         |
| Strategická webová hra s mapou vesnic 					    | ![Java][java] ![ts][ts] |                                       |                                        |                                         |                                         |
| 3D desktop hra pomocí OpenGL s vlastním enginem a modely 			    | ![c++][c++] ![c][c] |                                       |                                        |                                         |                                         |
| Simulátor čerpací stanice (parallel, Go Routines, Go Concurrency, Docker) 	    | ![go][go] |                                       |                                        |                                         |                                         |
| Aplikace pro správu financí 							    | ![Java][java] ![js][js] |                                       |                                        |                                         |                                         |
| 3D webová hra Ping-pong pomocí Three.js 					    | ![js][js] |                                       |                                        |                                         |                                         |
| Webová hra pomocí čistého JavaScriptu (inspirace Bloons Tower Defense) 	    | ![js][js] |                                       |                                        |                                         |                                         |
| Webová aplikace ToDo List s databází a šifrováním (monolit architektura) 	    | ![js][js] |                                       |                                        |                                         |                                         |
| Desktop bojová hra (inspirace Swords and Sandals) 				    | ![c#][c#] |                                       |                                        |                                         |                                         |
| Pravděpodobnost a statistická analýza 					    | ![python][python] |                                       |                                        |                                         |                                         |
| Desktop aplikace Piškvorky 				  			    | ![Java][java]			   |                                       |                                        |                                         |                                         |
| Rozpoznávání řeči, objektů a textu v obraze (fotografie i videa) 		    | ![matlab][matlab] ![python][python] |                                       |                                        |                                         |                                         |
| Chytrá domácnost pomocí Raspberry Pi 				   		    | ![micropython][micropython] |                                       |                                        |                                         |                                         |
| Webscraper (web harvesting a extrakce dat) 					    | ![python][python] |                                       |                                        |                                         |                                         |
| Šifrovací algoritmy (Caesar, Vigenér, Substituční, Transpozice, RSA)  	    | ![Java][java] ![python][python] |                                       |                                        |                                         |                                         |
| Aplikace kalkulačky s vlastním UI  				   		    | ![matlab][matlab] |                                       |                                        |                                         |                                         |
| Kompresní algoritmy (Huffman, LZW, BWT, RLE)  				    | ![Java][java] ![python][python] |                                       |                                        |                                         |                                         |
