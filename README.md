...
|-----------------------------------------------------------------------------------|--------------------------------------|---------------------------------------|----------------------------------------|-----------------------------------------|-----------------------------------------|
| Self hosted smart home on ubuntu server with HA |          |          |          |          |
...
| Bachelor's Thesis - Integrating ESP32 into a Smart Home System 	    | ![c++][c++] ![c][c] | ![vs] |                                        |                                         |                                         |
| Click-Based Web Game with Database and Login (3-Tier Architecture) 		    | ![Java][java] ![ts][ts] |                                       |                                        |![mysql]|       |
| Strategic Web Game with a Village Map (Inspired by Tribal Wars) 					    | ![Java][java] ![ts][ts] |                                       |                                        |                                         |                                         |
| 3D Desktop Game using OpenGL with a Own Custom Engine and Models 			    | ![c++][c++] ![c][c] |                                       |                                        |                                         |                                         |
| Gas Station Simulator (Parallel, Go Routines, Go Concurrency, Docker) 	    | ![go][go] |                                       |                                        |                                         |                                         |
| Finance Management Web Application 							    | ![Java][java] ![js][js] |                                       |                                        |                                         |                                         |
| 3D Web Ping-Pong Game using Three.js 					    | ![js][js] |                                       |                                        |                                         |                                         |
| Web Game using Pure JavaScript (Inspired by Bloons Tower Defense) 	    | ![js][js] |                                       |                                        |                                         |                                         |
|To-Do List Web Application with Database and Encryption (Monolithic Architecture) 	    | ![js][js] |                                       |                                        |                                         |                                         |
